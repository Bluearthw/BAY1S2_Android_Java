...
import be.kuleuven.gt.tutorial.model.CoffeeOrderAdapter;

public class ShowQueueActivity extends AppCompatActivity {

    private static final String QUEUE_URL = "https://studev.groept.be/api/a22pt211/test2retrieve";
...
//        orderQueueView.setOnClickListener(new View.OnClickListener(){
...
// iteration 3
    ...
    public void onOrder_clicked(View caller) {
        Intent intent = new Intent(this, IntoTheCardView.class);
